...
def generate_base_pose( pdb_file, params_dir, rounds ):
    # imports
    import rosetta
...
if __name__ == "__main__":
    # if this is run as a script, read command-line arguments
    import argparse
    ...
    # run main
    generate_base_pose( input_args.pdb_file, input_args.params_dir, input_args.rounds )
