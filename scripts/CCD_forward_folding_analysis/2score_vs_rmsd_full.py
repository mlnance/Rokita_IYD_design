...
'''
Example Execution:
./2score_vs_rmsd_full.py -n native_pdb/native.pdb -r resfile/res.file in_pdb/*pdb
'''
...
try:
    ...
    # rosettautil lives here
    sys.path.append("/Users/mlnance/work/Rosetta/tools/protein_tools")
    sys.path.append("/Users/mlnance/work/Rosetta/tools/protein_tools/scripts")
    import rosettautil
...
clustalw_exe = "/Applications/clustalw-2.1-macosx/clustalw2"
